      ...
      <div className="container mx-auto">
        <div className="flex gap-8 py-20 lg:pt-5 lg:pb-15 items-center justify-center flex-col relative">
          <div className="flex gap-4 flex-col">
            <img src="/images/Shopping bag-amico.svg" alt="A hand holding shopping bags" className="w-60 absolute left-[4%] top-[30%] z-[-10] opacity-90"/>
            <img src="/images/Shopping bag-amico.svg" alt="A hand holding shopping bags" className="w-60 absolute right-[4%] top-[30%] z-[-10] opacity-90" />
